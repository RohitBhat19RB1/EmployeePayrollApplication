...
const createEmployeePayroll = () => {
    ...
    let date = getInputValueById('#day')+" "+getInputValueById('#month')+" "+
                getInputValueById('#year');
    employeePayrollData.startDate =new Date(parseInt(document.getElementById("day").value), parseInt(document.getElementById("month").value) - 1, parseInt(document.getElementById("year").value));
    alert(employeePayrollData.toString());
    return employeePayrollData;
}
